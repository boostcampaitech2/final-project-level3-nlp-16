...
def main():
    ...
    tokenizer = AutoTokenizer.from_pretrained(
        "/opt/ml/final-project-level3-nlp-16/code/text_generation/output/hash-tag-generator-small"
    )
